...
describe('GRADING DOM MANIPULATION TEST: ', function () {
  ...
  it('Launch CheckList is ready to go', function () {
    ...
    expect(list.style.visibility).toEqual('hidden'); // passes only if inline styling added to HTML
  ...
  it('Script contains calls to appropriate helper functions', function () {
    ...
    // typos in "Destination" and .toBeTrue() below, but this is also tested in grading-fetch.spec.js so I commented it out
